...
module.exports = class Selector {
    ...
    _updatePos(ev) {
        ...
        if (
            this.pos.x >= 0 &&
            this.pos.x <= canvasRect.width &&
            this.pos.y >= 0 &&
            this.pos.y <= canvasRect.height
        ) {
            ...
            this.pos.x =
                this.pos.x / (this.aspectRatio[0] * camScale[0]) - camPos[0];
            this.pos.y =
                this.pos.y / (this.aspectRatio[1] * camScale[1]) - camPos[1];
    ...
    update() {
        ...
        if (
            ...
            this.icons.selectIcon(
                this.selectedIcon,
                this.selectedAnimVal,
                false
            );
