...
module.exports = class App extends App_Base {
    ...
    async scanTextureFile(num = 1) {
        ...
        if (fileParts.length >= 2) {
            ...
            if (baseName.substr(-3, 1) == "-") {
                fileParts[fileParts.length - 2] = baseName.substr(
                    0,
                    baseName.length - 3
                );
            }
    ...
    async run() {
        ...
        this.tabManager = new Tab_Manager(
            tab_tabContainer_bfres,
            tab_contentContainer_bfres
        );
        ...
        let filePath =
            ...
            "/content/Model/Animal_Goat.sbfres"; // TEST
