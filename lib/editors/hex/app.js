...
module.exports = class Editor_Hex {
    ...
    loadData() {
        ...
        this.data = this.file.buffer.slice(
            this.fileOffset,
    ...
    renderData(fileOffset) {
        this.node.querySelector(".data-header-dataOffset").innerHTML =
            "0x" + this.fileOffset.toString(16);
        this.node.querySelector(".data-header-dataSize").innerHTML =
            "0x" + this.fileLength.toString(16);
