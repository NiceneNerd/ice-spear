...
module.exports = class FTEX_Swizzler
{
    ...
    deswizzle(width, height, height2, index, format_, tileMode, swizzle_, pitch, bpp, completeData)
    {
        const singleBufferSize = completeData.length / height2;
        const bufferStart = index * singleBufferSize;
        const data = completeData.slice(bufferStart, bufferStart + singleBufferSize);
