...
module.exports = class Actor_GUI
{
    ...
    update()
    {
        ...
        {
            this.nodeCache.querySelector(".data-actor-type").value = this.actor.type;
        }else{
            this.nodeCache.querySelector(".data-actor-type").hidden = true;
        }
    ...
    _addCallbacks()
    {
        ...
        this.nodeCache.querySelector(".data-actor-type").onchange = (ev) => { 
            this.actor.changeType(ev.target.value);
        };

        this.nodeCache.querySelector(".data-tool-deselect").onclick = () => this.actor.handler.deselectActor(this.actor);
        this.nodeCache.querySelector(".data-tool-focus").onclick = () => this.actor.handler.focusActor(this.actor);
