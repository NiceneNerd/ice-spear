...
module.exports = class Actor
{
    ...
    async importParamJSON(jsonString, keepPosition = false) 
    {
        ...
        if(newParams == null || typeof(newParams) != "object" || newParams.HashId == null) 
        {
            swal({
                title: "JSON is invalid!", 
                html: "Make sure your clipboard contains a valid actor JSON.\nContent: " + jsonString.substr(0, 100),
                type: "error" 
            });
            return;
        }
