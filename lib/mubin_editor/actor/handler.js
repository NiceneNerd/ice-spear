...
module.exports = class Actor_Handler
{
    ...
    constructor(shrineRenderer, project, loader, stringTable = null)
    {
        ...
        this.actorObjLoader = new Actor_Object_Loader(actorPath, modelsPath, actorCache, this.loader, this.stringTable);
        this.actorObjLoader.shrineRenderer = this.shrineRenderer;
    ...
    clear()
    {
        this.actorObjLoader.clear();

        const Actor_Object = require('./actor_object'); // old
        //const Actor_Object = require('./object/object');

        this.actorObjLoader.objects.DUMMY_BOX = new Actor_Object(this.shrineRenderer);
        this.actorObjLoader.objects.DUMMY_BOX.setThreeModel(this.shrineRenderer.renderer.createBox());
    ...
    {
        const actorObject = await this.actorObjLoader.getObject(name);
