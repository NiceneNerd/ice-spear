...
module.exports = class History_Controls {
     ...
     */
    _attachView() {
        const historyControlsNode = new HTML_Loader(
            "html/history_controls.html"
        ).create();
    ...
    _attachEvents() {
        ...
        this.uiNodeCache.get(".data-history-undo").onclick = ev => this.undo();
        this.uiNodeCache.get(".data-history-redo").onclick = ev => this.redo();
    ...
    update(history) {
        ...
        this.uiNodeCache.get(".data-history-posCurrent").innerHTML =
            this.history.getPosition() + 1;
        this.uiNodeCache.get(".data-history-posTotal").innerHTML =
            this.history.count();
        this.uiNodeCache.get(".data-history-memSize").innerHTML =
            formatFilesize(this.history.getSize());
    }
};
