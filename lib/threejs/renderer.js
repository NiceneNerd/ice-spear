...
module.exports = class Renderer
{
    constructor(canvasNode)
    {
        ...
        try {
            ...
            gl = this.canvasNode.getContext('webgl2');
        } catch (err) {
            console.error(err);
        }
        ...
        // add some light
        this.ambientLight = new THREE.AmbientLight( 0xAAAABB );
        this.scene.add(this.ambientLight);

        this.cameraLight = new THREE.PointLight( 0xEEEEEE );
        this.cameraLight.position.set( 1, 3, 1 );
