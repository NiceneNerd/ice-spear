...
module.exports = class BXML_Node
{
    ...
    {
        let num = this.children == null ? 0 : Object.keys(this.children).length;

        if(deep && maxLevel != 0 && this.children != null) 
        {
            for(let i in this.children)
            {
                num += this.children[i].getChildCount(deep, maxLevel - 1);
            }
        }
        return num;
    }
    ...
    get(name)
    {
        ...
        if(this.children != null && this.children[currentHash] != null)
            return this.children[currentHash].get(name);
