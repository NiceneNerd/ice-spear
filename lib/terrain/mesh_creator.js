...
{
    constructor(mapBuffer, material)
    {
    ...
    create()
    {
        ...
        geometry.addAttribute('color', new THREE.BufferAttribute(this.material, 4));
        ...
        const material = new THREE.MeshPhongMaterial( { color: 0xffffff, flatShading: false, vertexColors: THREE.VertexColors, shininess: 0 } );
...
module.exports = function(mapBuffer, material)
{
    const creator = new Terrain_Mesh_Creator(mapBuffer, material);
