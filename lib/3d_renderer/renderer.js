...
module.exports = class Renderer
{
    ...
    start()
    {
        ...
        if(this.animFrame == null)
        {
            this.animFrame = 0;
            this._frame();
            //this.timer.setInterval(() => { this._frame(); }, "", "16.6666666m");
        }
    }
    ...
    _frame()
    {
        if(this.animFrame != null)
        {
            ...
            this.frameDurationScale = (drawTime - this.timeLastFrameEnd) / SCALING_FRAME_TIME;
            ...
            this.timeLastFrameEnd = window.performance.now();
            this.animFrame = setTimeout(() => { this._frame(); }, timeoutTime); // timeOut ~60FPS, draw time correction (best)
            //this.animFrame = requestAnimationFrame(() => { this._frame(); }); // animationFrame
            //this.animFrame = setTimeout(() => { this._frame(); }, this.targetFrameTime); // timeOut ~60FPS, depending on draw duration
        }
    }
