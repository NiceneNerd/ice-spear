...
THREE.SMAAShader = [ {
	...
	fragmentShader: [
		...
		"void main() {",
			...
			"fragmentColor = SMAAColorEdgeDetectionPS( vUv, vOffset, tDiffuse );",
	...
	fragmentShader: [
		...
		"void main() {",
			...
			"fragmentColor = SMAABlendingWeightCalculationPS( vUv, vPixcoord, vOffset, tDiffuse, tArea, tSearch, ivec4( 0.0 ) );",
	...
	fragmentShader: [
		...
		"void main() {",
			...
			"fragmentColor = SMAANeighborhoodBlendingPS( vUv, vOffset, tColor, tDiffuse );",
